            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li class="page-scroll">
                        <a class="text-center" href="#portfolio">Premier</a>
                    </li>
                    <li class="page-scroll">
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/tshirt2.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                ...
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/longtee.png" class="img-responsive" alt="">
                    </a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/hood3.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal5" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/shirt10.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/coach1.png" class="img-responsive" alt="">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 id="about" style="padding-bottom:50px; padding-top:70px;">ABOUT</h2>
                    ...
                    <br />
                    <h5><b>Est.</b> <a href="https://www.google.co.uk/?gfe_rd=cr&ei=1a6oWJ6oGsPW8gfdoIqACA&gws_rd=ssl#q=Belfast%2C+Northern+Ireland">Belfast, Northern Ireland.</></a></h5><span class="fa fa-search"
                    <br />
                    <br />
                    <br />
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12 text-center">
                                <button type="submit" class="btn btn-default btn-md"><span class="fa fa-send"</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h6>Copyright &copy; 2017<br />
                            <a style="color:#80ffe0" href="index.php"<b>www.nosebunk.com</b></h6></b></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <hr class="star-primary">
                            <img src="img/portfolio/shirt10.png" class="img-responsive img-centered" alt="">
